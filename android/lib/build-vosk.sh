...
# 修复 DTB_DEFAULT_ENTRIES 未定义的问题
if [ -f param.h ] && ! grep -q "DTB_DEFAULT_ENTRIES" param.h; then
  echo "#ifndef DTB_DEFAULT_ENTRIES" >> param.h
  echo "#define DTB_DEFAULT_ENTRIES 256" >> param.h
  echo "#endif" >> param.h
fi
